...
const PokeCard = ({pokemonId, pokemonData, history}) => {
    ...
    return (
        <div className="col card m-3" style={{width: '15rem', height: '18rem'}} onClick={()=> history.push(`/pokedex/pokemon/${pokemonId}`)} data-bs-toggle="tooltip" data-bs-placement="top" title={name}>
